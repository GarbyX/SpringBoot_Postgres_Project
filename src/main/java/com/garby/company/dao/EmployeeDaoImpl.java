...
import com.garby.company.mapper.EmployeeRowMapper;
...
public class EmployeeDaoImpl implements EmployeeDao{
    ...
    public void executeUpdateEmployee(Employee emp) {
        ...
        Map<String,Object> map=new HashMap<String,Object>();     // Explicit type arg String,Obj can be replaced with <>
        ...
        template.execute(sql,map,new PreparedStatementCallback<Object>() {
            // Anonymous new PreparedStatementCallback<Object>() can be replaced with method reference or lambda
            @Override
            public Object doInPreparedStatement(PreparedStatement ps)
            // Not annotated parameter overrides @NotNullApi parameter
